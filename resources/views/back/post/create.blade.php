...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form id="msform" class="mb-5" method="post" action="{{ route('posts.store') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" value="{{ old('title') }}" maxlength="65000" autocomplete="off" name="title"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group" id="urlwraper">
                            ...
                            <input autocomplete="off" type="text" value="{{ old('slug') }}" name="slug"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="file_chooser banner" data-type="banner" title="Haz clic para agregar una imagen"
                            style="background-image: url('{{ asset( old('banner') ? \App\Image::find(old('banner'))->get_route() : 'img/default-image.png' ) }}')"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="file_chooser preview" data-type="image" title="Haz clic para agregar una imagen"
                            style="background-image: url('{{ asset( old('image') ? \App\Image::find(old('image'))->get_route() : 'img/default-image.png' ) }}')"
                            data-toggle="modal" data-target="#modal-multimedia">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" value="{{ old('meta_title') }}" autocomplete="off" name="meta_title"
                            class="form-control">
        ...
        $(".file_chooser").click(function(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.length == 0){
                        $(".modal-body .row").append(`<div class="col-sm-12"><em>No hay imágenes subidas</em></div>`)
                        return
                    }
