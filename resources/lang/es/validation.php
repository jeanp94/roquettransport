...
return [
	...
	*/
    ...
    'greater_than_field'    => 'El campo :attribute debe ser mayor que :other',
	...
	*/
    ...
    'attributes' => [
        ...
        'video_code' => 'codigo de coleccion',
        'videoname' => 'nombre del video',
        'videodescription' => 'descripcion del video',
        'country' => 'país',
        'location_string' => 'ubicación',
        'brand' => 'marca',
        'model' => 'modelo',
        'price' => 'precio',
